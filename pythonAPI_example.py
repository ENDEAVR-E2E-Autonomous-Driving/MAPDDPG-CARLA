...
def process_img(image):
    ...
    img_temp = img.reshape((600,800, 4))
...
try:
    ...
    """
    Initializing blueprints, blueprints contain necessary information a new actor (such as a car or pedestrian)
    ...
    # spawning the rgb camera relative to the car, 2 meters forward and 1.5 meters above
